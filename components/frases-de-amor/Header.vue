<template>
	<header class="header_blog_content">
			<div class="article_cover">
					<img alt='Imagen de fondo' width="1050" height='465' layout='responsive' src="@/assets/img/frases-de-amor/fondo.jpg" >
			</div>
					...
					<div class="header_blog_body">
							...
							<div class="header_blog_main_content">
									<div class="header_blog_main_text">
											<h1>Frases de amor cortas para mi novia o novio 【🥰】<span>.</span></h1>											
											<p>Comparte con tu novia o novio:<span></span></p>											
