<template lang="pug">
  .main
    ...
    div(class='text_image') 
      ...
      li Qué cortas se quedan las palabras para expresar lo que siento por ti. Si las letras de verdad pudieran decirte cuánto te quiero… Eres mi vida entera.
      li La mejor paradoja del amor es que, sin dejar de ser uno mismo, de repente te conviertes en dos.
      li Me di cuenta de que estaba enamorado de ti cuando, de repente, no quería irme a dormir: la vida real superaba a mis sueños.
    div(class="articles_section" )
      div(class="articles_wrapper")
          section(class="articles_content")
            aside( class="client_testimonial" )
