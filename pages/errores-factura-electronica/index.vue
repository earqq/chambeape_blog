...
export default {
  ...
  head () {
    return {
      ...
      link:[
        {
          rel:'canonical',href:'https://easybill.pe/errores-factura-electronica', 
        }
      ],
      meta: [
        { 'http-equiv': 'X-UA-Compatible', content: 'IE=edge' },
        { name: 'theme-color', content:'#17de8b'},
        { hid : 'description', name:'description', content:'Encuentra la descripción del error que te devolvió SUNAT cuando rechazó u observo tu comprobante electrónico (Factura,Boleta,Nota de Crédito, Nota de Débito, Guías de remisión)' },
